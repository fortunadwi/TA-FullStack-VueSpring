                ...
                <div class="content-wthree">
                  ...
                  <form @submit.prevent="loginkan">
                    ...
                    <input
                      ...
                      required=""
                    />
                    <p v-show="logingagal">Username Atau Password Salah</p>
                    ...
                    <ul>
                      <li>
                        <a href="#url" class="facebook"
                          ><i class="zmdi zmdi-facebook ml-3"></i>
                        </a>
                      </li>
                      <li>
                        <a href="#url" class="twitter"
                          ><i class="zmdi zmdi-twitter ml-3"></i>
                        </a>
                      </li>
                      <li>
                        <a href="#url" class="pinterest"
                          ><i class="zmdi zmdi-pinterest-box ml-3"></i>
                        </a>
                      </li>
                    </ul>
                  </div>
